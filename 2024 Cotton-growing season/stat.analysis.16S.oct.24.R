...
alpha <- read_tsv(file="final.opti_mcc.groups.ave-std.oct.24.bacterial.summary", 
...
location_shannon +
  geom_text(data=tibble(x=1, y=6.98), 
            aes(x=x, y=y, label="*"), size=9,
            inherit.aes = FALSE) 

ggsave("shannon.16S.oct.24.location.png", width=9, height=7)
...
meta_alpha %>%
  ...
  labs(x=NULL,
       ...
       title="Comparison of In-season Bacterial Observed Diversity") +
  theme_classic() +
...
ggsave("sobs.16S.oct.24.location.png", width=8, height=6)
...
meta_alpha %>%
  ...
  labs(x=NULL,
       y="Shannon Evenness",
       title="Comparison of In-season Bacterial Evenness") +
  theme_classic() +
  theme(axis.text.x = element_markdown(size=10),
        axis.text.y = element_markdown(size=10),
        legend.position = "none",
...
ggsave("even.16S.oct.24.location.png", width=8, height=6)
...
meta_alpha %>%
  ...
  labs(x=NULL,
       y="Shannon",
       title="Comparison of In-season Bacterial Shannon Diversity") +
  theme_classic() +
  theme(axis.text.x = element_markdown(size=10),
        axis.text.y = element_markdown(size=10),
        legend.position = "none",
...
ggsave("shannon.16S.oct.24.trt.png", width=8, height=6)
...
ggsave("even.16S.oct.24.trt.png", width=8, height=6)
...
location_facet <- meta_alpha_long %>%
  ...
  labs(x=NULL,
       y=NULL,
       title="Cotton-growing Season Additional Bacterial Diversity Indices") +
  theme_light() +
  theme(axis.text.x = element_markdown(size=16),
        axis.text.y = element_markdown(size=12),
...
ggsave("other.metrics.16S.oct.24.location.png", width=14, height=8)
