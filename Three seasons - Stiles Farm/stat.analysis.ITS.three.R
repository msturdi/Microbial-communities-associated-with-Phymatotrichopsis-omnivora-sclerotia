...
metadata <- read_excel(path="metadata.three.fungal.xlsx") %>%
  mutate(combo = glue("{season} {treatment}"))

alpha <- read_tsv(file="final.opti_mcc.groups.ave-std.three.fungal.summary", 
...
#assessing sig. of metrics because they are all non-normal but homoscedastic 
...
meta_alpha %>%
  ...
  labs(x=NULL,
       y="Shannon",
       title="Comparison of Three Seasons of Fungal Shannon Diversity<br>Stiles Farm") +
  theme_classic() +
...
ggsave("shannon.ITS.three.png", width=8, height=6)
...
meta_alpha %>%
  ...
  labs(x=NULL,
       ...
       title="Comparison of Three Seasons of Fungal Observed Diversity<br>Stiles Farm") +
  theme_classic() +
  theme(axis.text.x = element_markdown(size=10),
        axis.text.y = element_markdown(size=10),
        legend.position = "none",
...
ggsave("sobs.ITS.three.png", width=8, height=6)
...
meta_alpha %>%
  ...
  labs(x=NULL,
       y="Shannon Evenness",
       title="Comparison of Three Seasons of Fungal Evenness<br>Stiles Farm") +
  theme_classic() +
  theme(axis.text.x = element_markdown(size=10),
        axis.text.y = element_markdown(size=10),
        legend.position = "none",
...
ggsave("even.ITS.three.png", width=8, height=6)
...
meta_alpha %>%
  ...
  labs(x=NULL,
       y="Shannon",
       title="Comparison of Three Seasons of Fungal Diversity<br>Stiles Farm") +
  theme_classic() +
  theme(axis.text.x = element_markdown(size=10),
        axis.text.y = element_markdown(size=10),
        legend.position = "none",
...
ggsave("shannon.ITS.three.trt.png", width=10, height=6)
