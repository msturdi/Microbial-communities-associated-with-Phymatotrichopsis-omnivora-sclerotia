...
shared_file <- read_tsv("final.opti_mcc.0.03.subsample.fungal.BF.shared")
...
read_tsv(in_off) %>%
  ...
  labs(y=NULL, x="LDA Score(log 10)",
       title="LDA Plot (LDA > 2.5) In- vs. Off-season Fungal<br>Bottom Farm") +
  scale_x_continuous(expand = c(0,0), limits = c(0, 4.5), breaks = seq(0, 4, by=2)) +
...
ggsave("lefse.in.off.ITS.season.BF.png", width=12, height=15)
...
read_tsv(ilive_inone) %>%
  ...
  scale_x_continuous(expand = c(0,0), limits = c(0, 5), breaks = seq(0, 4.2, by=2)) +
  scale_fill_manual(name=NULL, 
...
ggsave("lefse.ilive.inone.ITS.BF.png", width=10, height=8)
...
read_tsv(idead_inone) %>%
  ...
  labs(y=NULL, x="LDA Score(log 10)",
       title="LDA Plot (LDA > 2.5) In-season Fungal<br>Bottom Farm") +
  scale_x_continuous(expand = c(0,0), limits = c(0, 5), breaks = seq(0, 4, by=2)) +
  scale_fill_manual(name=NULL, 
...
ggsave("lefse.idead.inone.ITS.BF.png", width=10, height=8)
...
read_tsv(olive_onone) %>%
  ...
  geom_col() +
  labs(y=NULL, x="LDA Score(log 10)",
       title="LDA Plot (LDA > 2.5) Off-season Fungal<br>Bottom Farm") +
  scale_x_continuous(expand = c(0,0), limits = c(0, 4.5), breaks = seq(0, 4, by=2)) +
  scale_fill_manual(name=NULL, 
...
ggsave("lefse.olive.onone.ITS.BF.png", width=12, height=10)
...
ggsave("lefse.odead.onone.ITS.BF.png", width=12, height=6)
...
read_tsv(ilive_olive) %>%
  ...
  geom_col() +
  labs(y=NULL, x="LDA Score(log 10)",
       title="LDA Plot (LDA > 2.5) In- vs. Off-Season<br>Live Sclerotia Bottom Farm") +
  scale_x_continuous(expand = c(0,0), limits = c(0, 5), breaks = seq(0, 4, by=2)) +
  scale_fill_manual(name=NULL, 
...
ggsave("lefse.ilive.olive.ITS.BF.png", width=12, height=16)
...
read_tsv(idead_odead) %>%
  ...
  geom_col() +
  labs(y=NULL, x="LDA Score(log 10)",
       title="LDA Plot (LDA > 2.5) In- vs. Off-Season<br>Dead Sclerotia Bottom Farm") +
  scale_x_continuous(expand = c(0,0), limits = c(0, 5), breaks = seq(0, 4, by=2)) +
  scale_fill_manual(name=NULL, 
...
ggsave("lefse.idead.odead.ITS.BF.png", width=12, height=12)
