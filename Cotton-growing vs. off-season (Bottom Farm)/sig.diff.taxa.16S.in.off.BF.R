...
shared <- read_tsv("final.opti_mcc.0.03.subsample.bacterial.BF.shared",
...
composite %>%
  ...
  labs(x= "Relative abundance", y=NULL,
       title="Significantly Different Orders (Bacterial)<br>In- vs. Off-season Bottom Farm") +
  theme_light() +
...
ggsave("sig.diff.orders.16S.in.off.BF.png", width=12, height=13)
...
composite %>%
  ...
  scale_fill_manual(NULL,
                    ...
                    labels = c("In-season Live", "Off-season Live"))  +
  labs(x= "Relative abundance", y=NULL,
       title="Significantly Different Orders (Bacterial)<br>Bottom Farm In- vs. Off-season") +
  theme_light() +
  theme(axis.text.y = element_markdown(size=9),
        legend.text = element_markdown(size=10),
        legend.key.size = unit(15, "pt"),
