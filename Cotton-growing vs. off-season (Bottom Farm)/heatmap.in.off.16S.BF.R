...
order_rel_abund_mean %>%
  ...
  scale_y_discrete(breaks=c("Caryophanales", "Hyphomicrobiales", "Unclassified Bacteria", "Rhodospirillales", "Acidobacteria Gp6 incertae sedis", "Gaiellales", "Solirubrobacterales", 
                            "Rubrobacterales", "Propionibacteriales", "Micromonosporales", "Unclassified Actinomycetota"),
                   labels=c("Caryophanales", "**Hyphomicrobiales (Off)***", "Unclassified Bacteria", "Rhodospirillales", "**Acidobacteria Gp6 incertae sedis (Off)***", "Gaiellales", 
                            "**Solirubrobacterales (In)***", "**Rubrobacterales (In)***", "Propionibacteriales", "Micromonosporales", "**Unclassified Actinomycetota (In)***")) +
  labs(title="Relative Abundance of the Top 11 Bacterial Orders<br>**Bottom Farm (Non-conducive)**",
       x=NULL,
       y=NULL) +
  theme_classic() +
...
ggsave("heatmap.16S.order.BF.ave.png", width=17, height=15)
