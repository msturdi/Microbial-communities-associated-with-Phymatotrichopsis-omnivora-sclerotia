...
shared <- read_tsv("final.opti_mcc.0.03.subsample.fungal.stiles.shared",
...
composite %>%
  ...
  labs(x= "Relative abundance", y=NULL,
       title="Significantly Different Orders (Fungal)<br>In- vs. Off-season Stiles Farm") +
  theme_light() +
...
ggsave("sig.diff.orders.ITS.in.off.stiles.png", width=12, height=10)
...
composite %>%
  ...
  scale_fill_manual(NULL,
                    ...
                    labels = c("In-season Live", "Off-season Live"))  +
  labs(x= "Relative abundance", y=NULL,
       title="Significantly Different Orders (Fungal)<br>Stiles Farm In- vs. Off-season") +
  theme_light() +
  theme(axis.text.y = element_markdown(size=9),
        legend.text = element_markdown(size=10),
        legend.key.size = unit(15, "pt"),
