...
shared_file <- read_tsv("final.opti_mcc.0.03.subsample.fungal.stiles.shared")
...
read_tsv(in_off) %>%
  ...
  labs(y=NULL, x="LDA Score(log 10)",
       title="LDA Plot (LDA > 2.5) In- vs. Off-season Fungal<br>Stiles Farm") +
  scale_x_continuous(expand = c(0,0), limits = c(0, 5.5), breaks = seq(0, 4, by=2)) +
...
ggsave("lefse.in.off.ITS.season.stiles.png", width=12, height=13)
...
read_tsv(ilive_inone) %>%
  ...
  scale_x_continuous(expand = c(0,0), limits = c(0, 5.5), breaks = seq(0, 4.2, by=2)) +
  scale_fill_manual(name=NULL, 
...
ggsave("lefse.ilive.inone.ITS.stiles.png", width=10, height=8)
...
ggsave("lefse.idead.inone.ITS.stiles.png", width=10, height=8)
...
ggsave("lefse.olive.onone.ITS.stiles.png", width=12, height=10)
...
ggsave("lefse.odead.onone.ITS.stiles.png", width=12, height=6)
...
ggsave("lefse.ilive.olive.ITS.stiles.png", width=12, height=16)
...
ggsave("lefse.idead.odead.ITS.stiles.png", width=12, height=12)
