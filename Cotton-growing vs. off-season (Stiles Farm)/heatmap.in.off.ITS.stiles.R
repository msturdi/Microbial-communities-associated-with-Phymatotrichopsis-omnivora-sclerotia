...
order_rel_abund_mean %>%
  ...
  scale_y_discrete(breaks=c("Eurotiales", "Hypocreales", "Pleosporales", "Sordariales", "Capnodiales"),
                   labels=c("**Eurotiales (In)***", "**Hypocreales (Off)***", "**Pleosporales (Off)***", "Sordariales", "**Capnodiales (Off)***")) +
  labs(title="Relative Abundance of the Top 5 Fungal Orders<br>**Stiles Farm (Conducive)**",
       x=NULL,
       y=NULL) +
  theme_classic() +
...
ggsave("heatmap.ITS.order.stiles.ave.png", width=16, height=8)
